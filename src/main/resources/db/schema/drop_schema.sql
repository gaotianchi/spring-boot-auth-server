-- 删除表中涉及的外键约束
alter table blog_auth.role_permission
    drop foreign key role_permission_permission_code_fk;
alter table blog_auth.role_permission
    drop foreign key role_permission_role_code_fk;
alter table blog_auth.user_role
    drop foreign key user_role_role_code_fk;
alter table blog_auth.user_role
    drop foreign key user_role_user_id_fk;
alter table blog_auth.action_log
    drop foreign key action_log_user_id_fk;
